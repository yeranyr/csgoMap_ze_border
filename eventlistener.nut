...
function FireEventFormat(id ,event_data) {
    ...
    switch (args.len()) {
	    ...
	    case 9:
            ...
            break
	    case 10:
            getroottable()[name](args[1],args[3],args[4],args[5],args[6],args[7],args[8],args[9],args[10])
            break
    }
}
...
::OnGameEvent_player_use <- function (eventData) {

    ScriptPrintMessageChatAll("player_use")
