...
l3_door2 <- TEXT_BEFOR + "zombia passage door is openning in \x04 5 seconds" + TEXT_AFTER
...
l1_elev_add1 <- TEXT_BEFOR + "The freight elevator is leaving in \x04 3seconds" + TEXT_AFTER
...
l3g_door2 <- TEXT_BEFOR + "The gate of the laboratory is openning in \x04 30 seconds" + TEXT_AFTER
